...
setup(name=name,
    ...
    # additional files need to be installed into a package, there files are often data
    # that's closely related to the package's implementation, or text files containing
    # documentation that might be of interest to programmers using package.
    package_data={
